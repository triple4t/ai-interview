...
(function() {
  function removeNextJSLogo() {
    ...
    const nextLogos = document.querySelectorAll('svg[data-next-mark-loading], svg[width="40"][height="40"], svg[viewBox="0 0 40 40"]');
    ...
    allSvgs.forEach(svg => {
      ...
      paths.forEach(path => {
        ...
        if (d.includes('M13.3') || d.includes('M11.825') || d.includes('next_logo_paint')) {
    ...
    const nextElements = document.querySelectorAll('[class*="next"], [class*="Next"], [data-next-mark-loading]');
