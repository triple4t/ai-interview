...
export const JobRecommendations = ({ jobs, onJobSelect }: JobRecommendationsProps) => {
                ...
                <Card className="w-full">
                    <CardContent className="p-8 text-center">
                        <div className="space-y-4">
                            ...
                            <h3 className="text-lg font-medium text-gray-900">No Job Matches Found</h3>
                            <p className="text-gray-500">
                                We couldn't find any job descriptions that match your resume with 65% or higher compatibility.
                                Try uploading a different resume or check back later for new opportunities.
                            </p>
                        </div>
                    </CardContent>
                </Card>
        ...
        >
            <div className="text-center">
                ...
                <p className="text-gray-600">
                    Found {jobs.length} job(s) that match your resume with 65%+ compatibility
                </p>
            </div>
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <Badge className={`${getMatchColor(job.match)} flex items-center gap-1`}>
                                ...
                                {expandedJob === job.id && (
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-3 pt-4">
                                            ...
                                            <Button
                                                variant="outline"
                                                onClick={() => window.open(`/api/v1/resume/jd/${job.jdSource}`, '_blank')}
                                            >
                                                View Full JD
                                            </Button>
                                        </div>
